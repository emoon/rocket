...
#define EMGUI_COLOR32(r, g, b, a) ((a << 24) | (b << 16) | (g << 8) | r)
...
int Emgui_loadFontBitmap(const char* buffer, int len, enum EmguiMemoryLocation location, int rangeStart, int rangeEnd,
                         struct EmguiFontLayout* layout);
